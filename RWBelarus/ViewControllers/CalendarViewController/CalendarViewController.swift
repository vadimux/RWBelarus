...
class CalendarViewController: UIViewController {
    ...
    private func updateNavigationButtonsState(currentDate: Date) {
        ...
        backButton.tintColor = previousAvailable ? UIColor(rgb: 0x36608A) : UIColor.gray
        nextButton.tintColor = nextAvailable ? UIColor(rgb: 0x36608A) : UIColor.gray
    }
        ...
        if #available(iOS 11.0, *) {
            ...
            case .none:
                if calendar.isDateInToday(cellState.date) {
                    ...
                    cell.contentView.layer.borderColor = UIColor(rgb: 0x36608A).cgColor
